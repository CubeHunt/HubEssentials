...
public class ItemBuilder {
    ...
    public ItemBuilder(final Material material, final int amount) {
        ...
        this.meta = itemFactory.getItemMeta(material);
     ...
     */
    public ItemBuilder setAxolotlBucketVariant(final Axolotl.Variant variant) {
     ...
     */
    public ItemBuilder setSkullOwnerProfile(final UUID uuid) {
        if (meta instanceof SkullMeta skullMeta) {
            skullMeta.setOwnerProfile(Bukkit.createPlayerProfile(uuid));
        }
        return this;
    }
